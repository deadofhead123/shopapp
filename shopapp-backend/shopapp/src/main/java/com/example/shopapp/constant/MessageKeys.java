...
public class MessageKeys {
    ...
    public static final String CATEGORY_NOT_FOUND = "category.get_category_by_id.not_found";
    ...
    public static final String WRONG_ORDER_ID = "order.get_order_by_id.not_found";
    ...
    public static final String PRODUCT_NOT_FOUND = "product.get_product_by_id.not_found";

    public static final String UPLOAD_IMAGES_SUCCESSFULLY = "product.upload_images.upload_successfully";
